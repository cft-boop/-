...
import { ProjectStats } from '../types.ts';
...
const ProjectCharts: React.FC<ProjectChartsProps> = ({ data }) => {
  if (data.length === 0) {
    return (
      <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-center text-slate-400 h-[300px]">
